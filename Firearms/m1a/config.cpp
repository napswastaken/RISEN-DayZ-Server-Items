////////////////////////////////////////////////////////////////////
//DeRap: Nulled_Firearms\m1a\config.bin
...
class cfgWeapons
{
	...
	class NULLED_M1A_Base: Rifle_Base
	{
		scope = 0;
		weight = 2140;
		absorbency = 0.0;
	...
	class NULLED_M1A: NULLED_M1A_Base
	{
		scope = 2;
		displayName = "M1A";
		descriptionShort = "The Springfield Armory M1A is a civilian version of the M14 rifle designed and manufactured by Springfield Armory, Inc";
		model = "Firearms\M1A\M1A.p3d";
		attachments[] = {"weaponOptics","weaponWrap","weaponOpticsHunting","weaponMuzzleAK"};
		itemSize[] = {8,3};
