////////////////////////////////////////////////////////////////////
//DeRap: Nulled_Firearms\SVU\config.bin
...
class CfgPatches
{
	class SVU
	{
		...
		weapons[] = {"NULLED_SVU"};
		requiredVersion = 0.1;
		requiredAddons[] = {"DZ_Data","DZ_Weapons_Firearms","NULLED_Weapons_Supports","NULLED_Weapons_Ammunition","NULLED_Weapons_Supports"};
	};
};
class Mode_Safe;
class Mode_SemiAuto;
...
class cfgWeapons
{
	...
	class SVU_Base: Rifle_Base
	{
		...
		{
			soundSetShot[] = {"SVU_Shot_SoundSet","AK_Tail_SoundSet","AK_InteriorTail_SoundSet"};
	...
	class NULLED_SVU: SVU_Base
	{
		scope = 2;
		displayName = "SVU-971";
		descriptionShort = "The SVU-971 is a Russian (formerly the Soviet Union) selective fire 5.45×39mm assault rifle that was developed at the Kovrov Mechanical Plant (KMZ) by chief designer Sergey Koksharov in the late 1970s and 1980s the gun fires at a rate of 900 RPM";
		model = "Firearms\SVU\SVU.p3d";
