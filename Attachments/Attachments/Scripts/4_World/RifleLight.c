class RifleLight extends Switchable_Base
{
	UniversallightLight 	m_Light;
	
	static int			GLASS_ID = 1;
	
	static string 		LIGHT_OFF_GLASS 	= "Attachments\Data\PistolLight\textures\RifleLight_Lens.rvmat";
	static string 		LIGHT_ON_GLASS 		= "Attachments\Data\PistolLight\textures\RifleLight_Lens_on.rvmat";
