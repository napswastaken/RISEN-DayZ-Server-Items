class ActionIFAKSelfCB : ActionContinuousBaseCB
{
...
class ActionIFAKSelf: ActionContinuousBase
{
	void ActionIFAKSelf()
	{
		m_CallbackClass = ActionIFAKSelfCB;
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		if (health < 99 || player.IsBleeding())
		{
		return true;
		}
		else
